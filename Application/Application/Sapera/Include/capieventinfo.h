...
CORSTATUS CORAPIFUNC CorEventInfoClone(COREVENTINFO eventInfoFrom, PCOREVENTINFO eventInfoTo);
CORSTATUS CORAPIFUNC CorEventInfoFree(COREVENTINFO eventInfo);
