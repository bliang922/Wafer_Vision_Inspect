...
enum _SapFormat
{
   ...
   SapFormatMono8P5  = CORDATA_FORMAT_MONO8P5,
   SapFormatMono8P6  = CORDATA_FORMAT_MONO8P6,
   SapFormatMono8P7  = CORDATA_FORMAT_MONO8P7,
   SapFormatMono8P8  = CORDATA_FORMAT_MONO8P8,
   SapFormatMono8P9  = CORDATA_FORMAT_MONO8P9,
   SapFormatMono8P10 = CORDATA_FORMAT_MONO8P10,
   ...
   SapFormatMono16P5 = CORDATA_FORMAT_MONO16P5,
   SapFormatMono16P6 = CORDATA_FORMAT_MONO16P6,
   SapFormatMono16P7 = CORDATA_FORMAT_MONO16P7,
   SapFormatMono16P8 = CORDATA_FORMAT_MONO16P8,
   SapFormatMono16P9 = CORDATA_FORMAT_MONO16P9,
   SapFormatMono16P10 = CORDATA_FORMAT_MONO16P10,
   ...
   SapFormatCoord3D_CR16   = CORDATA_FORMAT_COORD3D_CR16,   // Obsolete (do not use)
   SapFormatCoord3D_ACRW16 = CORDATA_FORMAT_COORD3D_ACRW16,

   // Point Cloud formats
   SapFormatCoord3D_PC_XYZ = CORDATA_FORMAT_COORD3D_PC_XYZ,
...
class SAPCLASSBASIC_CLASS SapDataCoord3D_PC : public SapData
{
public:
   // Constructors
   SapDataCoord3D_PC()
      { m_Type = SapFormatTypeCoord3D_PC; }
   SapDataCoord3D_PC(float x, float y, float z)
      { m_Type = SapFormatTypeCoord3D_PC; m_Data.coord3d_pc.x = x; m_Data.coord3d_pc.y = y; m_Data.coord3d_pc.z = z; }
   SapDataCoord3D_PC(const SapData &data)
      { m_Type = SapFormatTypeCoord3D_PC; m_Data = data.GetData(); }

   SapDataCoord3D_PC &operator=(const SapData &data) { m_Type = SapFormatTypeCoord3D_PC; m_Data = data.GetData(); return *this; }

   // Data access methods
   float X() { return m_Data.coord3d_pc.x; }
   float Y() { return m_Data.coord3d_pc.y; }
   float Z() { return m_Data.coord3d_pc.z; }

   void Set(float x, float y, float z) { m_Data.coord3d_pc.x = x; m_Data.coord3d_pc.y = y; m_Data.coord3d_pc.z = z; }
};
