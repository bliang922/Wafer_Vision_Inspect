...
public:
	...
	static const EventType EventPoCL             = CORACQ_VAL_EVENT_TYPE_POCL;
   ...
   static const EventType EventExternalTriggerEnd = CORACQ_VAL_EVENT_TYPE_EXTERNAL_TRIGGER_END;
   ...
   static const EventType EventSlaveLinkLock   = CORACQ_VAL_EVENT_TYPE_SLAVE_LINK_LOCK;
   static const EventType EventSlaveLinkUnlock = CORACQ_VAL_EVENT_TYPE_SLAVE_LINK_UNLOCK;
	...
	enum _SignalStatus
	{
      ...
      SignalBitTransferRate    = CORACQ_VAL_SIGNAL_BIT_TRANSFER_RATE,
      SignalPoCLActive3        = CORACQ_VAL_SIGNAL_POCL_ACTIVE_3,
      SignalPoCLActive4        = CORACQ_VAL_SIGNAL_POCL_ACTIVE_4,
      SignalDataLanes          = CORACQ_VAL_SIGNAL_DATA_LANES,
      SignalSlaveLinkLock      = CORACQ_VAL_SIGNAL_SLAVE_LINK_LOCK,
	};
...
protected:
   ...
   virtual void SetSignalLossImmediateMode(BOOL signalLossImmediateMode)
      { m_SignalLossImmediateMode = signalLossImmediateMode; }
...
protected:
   ...
   BOOL     m_SignalLossImmediateMode; // TRUE to consider all losses of camera presence signal
}; 
