...
CORSTATUS CORAPIFUNC CorManGetDeviceInfoValueSize(CORSERVER hServer, PCSTR infoValueName, PUINT32 infoValueSize);
CORSTATUS CORAPIFUNC CorManReadDeviceInfoValue(CORSERVER hServer, PCSTR infoValueName, PSTR infoValue, UINT32 infoValueSize);

CORSTATUS CORAPIFUNC CorManGetSerialPortCount(CORSERVER hServer, PUINT32 serialCount);
CORSTATUS CORAPIFUNC CorManSetSerialPortComIndex(CORSERVER hServer, UINT32 serialIndex, UINT32 comIndex);
CORSTATUS CORAPIFUNC CorManGetSerialPortComIndex(CORSERVER hServer, UINT32 serialIndex, PUINT32 comIndex);
