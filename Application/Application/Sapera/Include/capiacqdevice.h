...
CORSTATUS CORAPIFUNC CorAcqDeviceGetCategoryFeatureCount(CORACQDEVICE acqDevice, UINT32 categoryIndex, UINT32 *featureCount);
CORSTATUS CORAPIFUNC CorAcqDeviceGetCategoryFeatureIndexes(CORACQDEVICE acqDevice, UINT32 categoryIndex, UINT32 *indexList, UINT32 indexListSize);
