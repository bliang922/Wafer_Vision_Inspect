 ...
 *-----------------------------------------------------------------------------
 */
CORSTATUS CORAPIFUNC CorManAllocContigBufferExEx (SIZE_T nbytes, UINT32 align, UINT32 overlap, PULONG_PTR pBufferphys, PVOID *ppBuffer);
typedef CORSTATUS (CCONV *CORMANALLOCCONTIGBUFFEREXEX) (SIZE_T nbytes, UINT32 align, UINT32 overlap, PULONG_PTR pBufferphys, PVOID *ppBuffer);
