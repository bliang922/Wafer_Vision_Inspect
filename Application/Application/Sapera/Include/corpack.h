...
#define CORDATA_PACK_COORD3D_C16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)) = (pData)->coord3d.c; \
	}

#define CORDATA_PACK_COORD3D_AC16(pData, pBuf) \
   {\
   *((UINT16 *)(pBuf)  ) = (pData)->coord3d.a; \
   *((UINT16 *)(pBuf)+1) = (pData)->coord3d.c; \
	}
...
#define CORDATA_PACK_COORD3D_ACRW16(pData, pBuf) \
   ...
   *((UINT16 *)(pBuf)  ) = (pData)->coord3d.a;        \
   *((UINT16 *)(pBuf)+1) = (pData)->coord3d.c;        \
   *((UINT16 *)(pBuf)+2) = (pData)->coord3d.r;        \
   *((UINT16 *)(pBuf)+3) = (pData)->coord3d.reserved; \
	}

#define CORDATA_PACK_COORD3D_PC_XYZ(pData, pBuf) \
   {\
   *((FLOAT *)(pBuf)  ) = (pData)->coord3d_pc.x;        \
   *((FLOAT *)(pBuf)+1) = (pData)->coord3d_pc.y;        \
   *((FLOAT *)(pBuf)+2) = (pData)->coord3d_pc.z;        \
	}

#define CORDATA_PACK_RGBAP8(pData, pBuf) \
	{\
	*((UINT8 *)(pBuf)  ) = (UINT8) (pData)->rgba.red;   \
	*((UINT8 *)(pBuf)+1) = (UINT8) (pData)->rgba.green; \
	*((UINT8 *)(pBuf)+2) = (UINT8) (pData)->rgba.blue;  \
	*((UINT8 *)(pBuf)+3) = (UINT8) (pData)->rgba.alpha; \
	}

#define CORDATA_PACK_RGBAP16(pData, pBuf) \
	{\
	*((UINT16 *)(pBuf)  ) = (pData)->rgba.red;   \
	*((UINT16 *)(pBuf)+1) = (pData)->rgba.green; \
	*((UINT16 *)(pBuf)+2) = (pData)->rgba.blue;  \
	*((UINT16 *)(pBuf)+3) = (pData)->rgba.alpha; \
	}
...
#define CORDATA_UNPACK_COORD3D_C16(pBuf, pData) \
   {\
   (pData)->coord3d.c = *((UINT16 *)(pBuf)  );        \
	}

#define CORDATA_UNPACK_COORD3D_AC16(pBuf, pData) \
   {\
   (pData)->coord3d.a = *((UINT16 *)(pBuf)  );        \
   (pData)->coord3d.c = *((UINT16 *)(pBuf)+1);        \
	}

#define CORDATA_UNPACK_COORD3D_ACRW16(pBuf, pData) \
   {\
   (pData)->coord3d.a = *((UINT16 *)(pBuf)  );        \
   (pData)->coord3d.c = *((UINT16 *)(pBuf)+1);        \
   (pData)->coord3d.r = *((UINT16 *)(pBuf)+2);        \
   (pData)->coord3d.reserved = *((UINT16 *)(pBuf)+3); \
	}

#define CORDATA_UNPACK_COORD3D_PC_XYZ(pBuf, pData) \
   {\
   (pData)->coord3d_pc.x = *((FLOAT *)(pBuf)  );        \
   (pData)->coord3d_pc.y = *((FLOAT *)(pBuf)+1);        \
   (pData)->coord3d_pc.z = *((FLOAT *)(pBuf)+2);        \
	}

#define CORDATA_UNPACK_RGBAP8(pBuf, pData) \
	{\
	(pData)->rgb.red   = (UINT16) *((UINT8 *)(pBuf)  ); \
	(pData)->rgb.green = (UINT16) *((UINT8 *)(pBuf)+1); \
	(pData)->rgb.blue  = (UINT16) *((UINT8 *)(pBuf)+2); \
	(pData)->rgb.alpha = (UINT16) *((UINT8 *)(pBuf)+3); \
	}

#define CORDATA_UNPACK_RGBAP16(pBuf, pData) \
	{\
	(pData)->rgb.red   = *((UINT16 *)(pBuf)  ); \
	(pData)->rgb.green = *((UINT16 *)(pBuf)+1); \
	(pData)->rgb.blue  = *((UINT16 *)(pBuf)+2); \
	(pData)->rgb.alpha = *((UINT16 *)(pBuf)+3); \
	}
