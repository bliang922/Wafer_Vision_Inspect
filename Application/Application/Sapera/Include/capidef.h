...
// Bits     Description
//-------------------------------------------------------------------------------
// (Obsolete usage of bits 0-7)
// 0-7:     WiT compatible type (used by Sapera Processing 4.2 and previous)
// (New usage of bits 0-7)
// 0-1:     MSB for format index (allows for 256 formats instead of 64)
// 2-3:     MSB for number of pages (allows for 64 pages instead of 16)
// 4-7:     Available for future use
// (End of new usage of bits 0-7)
// 8-15:    Number of bits per pixel
// 16-21:   LSB of index (used by internal implementation as an index to function table)
// 22-23:   Planar type (specifies the type color space on planar formats)
// 22-23:   Color alignement for bicolor and bayer format
// 24-27:   LSB of number of pages (specifies the number of pages of planar formats)
...
// IMPORTANT:
// 1) When CORDATA_FORMAT_MAX is above 64, we will need to change this macro, since there
//    are only 6 bits for the format index. This also requires a modification to the
//    CORDATA_FORMAT_INDEX macro later in this file.
// 2) When the number of planes is above 15, we will also need to change it, since there
//    are only 4 bits for the number of planes. This also requires a modification to the
//    CORDATA_FORMAT_NPAGES macro later in this file.
// 3) See the updated bit definitions above
...
#define CORDATA_FORMAT_COORD3D_CR16    (CORDATA_FORMAT( 2, 44, 16) | CORDATA_FORMAT_UNSIGNED)   // Obsolete (do not use)
...
// Point cloud
#define CORDATA_FORMAT_COORD3D_PC_XYZ     (CORDATA_FORMAT( 1, 49, 96) | CORDATA_FORMAT_SIGNED)

#define CORDATA_FORMAT_MONO8P5      (CORDATA_FORMAT( 5, 50,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO8P6      (CORDATA_FORMAT( 6, 51,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO8P7      (CORDATA_FORMAT( 7, 52,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO8P8      (CORDATA_FORMAT( 8, 53,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO8P9      (CORDATA_FORMAT( 9, 54,  8) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO8P10     (CORDATA_FORMAT( 10,55,  8) | CORDATA_FORMAT_UNSIGNED)

#define CORDATA_FORMAT_MONO16P5     (CORDATA_FORMAT( 5, 56, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P6     (CORDATA_FORMAT( 6, 57, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P7     (CORDATA_FORMAT( 7, 58, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P8     (CORDATA_FORMAT( 8, 59, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P9     (CORDATA_FORMAT( 9, 60, 16) | CORDATA_FORMAT_UNSIGNED)
#define CORDATA_FORMAT_MONO16P10    (CORDATA_FORMAT( 10,61, 16) | CORDATA_FORMAT_UNSIGNED)
...
//
// IMPORTANT:
// 1) When CORDATA_FORMAT_MAX is above 64, we will need to change the CORDATA_FORMAT
//    macro, since there are only 6 bits for the format index
// 2) When the number of planes is above 15, we will also need to change CORDATA_FORMAT,
//    since there are only 4 bits for the number of planes
// 3) See the comments before CORDATA_FORMAT for more details
#define CORDATA_FORMAT_MAX             62
...
//
// IMPORTANT:
// 1) When modifying CORDATA_FORMAT to support more than 64 formats, we also need to
//    change CORDATA_FORMAT_INDEX accordingly
// 2) When modifying CORDATA_FORMAT to support more than 15 pages, we also need to change
//    CORDATA_FORMAT_NPAGES accordingly
// 3) See the comments before CORDATA_FORMAT for more details
...
#define CORDATA_FORMAT_IS_MULTI(x) (										\
   ...
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P5)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P6)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P7)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P8)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P9)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO8P10)) || \
   ...
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P5)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P6)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P7)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P8)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P9)) || \
   (CORDATA_FORMAT_INDEX(x) == CORDATA_FORMAT_INDEX(CORDATA_FORMAT_MONO16P10)) || \
   ...
   (x == CORDATA_FORMAT_RGBAP8) || \
   (x == CORDATA_FORMAT_RGBAP16))
...
#define CORDATA_FORMAT_IS_COORD3D_PC(x) ( \
   (CORDATA_FORMAT_INDEX( x) == CORDATA_FORMAT_INDEX( CORDATA_FORMAT_COORD3D_PC_XYZ)))
...
#define  CORPORT_TYPE_XTIUM2CXPPX8CAMSIM  114
#define  CORPORT_TYPE_XTIUM2FLUORO	      115
#define  CORPORT_TYPE_CAMU3V			      116
#define  CORPORT_TYPE_XTIUM2CLMX4         117
