...
// Color RGB data format with components ordered as R -> G -> B
   ...
   {CORDATA_FORMAT_COORD3D_CR16, (UINT32)-1},	            // 57 Obsolete (do not use)
   ...
   // Point Cloud formats
   {CORDATA_FORMAT_COORD3D_PC_XYZ,	(UINT32)-1},            // 64

   // Multi-format (Planar Mono)
   {CORDATA_FORMAT_MONO8P5, (UINT32)-1},	                  // 65
   {CORDATA_FORMAT_MONO8P6, (UINT32)-1},	                  // 66
   {CORDATA_FORMAT_MONO8P7, (UINT32)-1},	                  // 67
   {CORDATA_FORMAT_MONO8P8, (UINT32)-1},	                  // 68
   {CORDATA_FORMAT_MONO8P9, (UINT32)-1},	                  // 69
   {CORDATA_FORMAT_MONO8P10, (UINT32)-1},	                  // 70
	{CORDATA_FORMAT_MONO16P5, (UINT32)-1},	                  // 71
	{CORDATA_FORMAT_MONO16P6, (UINT32)-1},	                  // 72
	{CORDATA_FORMAT_MONO16P7, (UINT32)-1},	                  // 73
	{CORDATA_FORMAT_MONO16P8, (UINT32)-1},	                  // 74
	{CORDATA_FORMAT_MONO16P9, (UINT32)-1},	                  // 75
	{CORDATA_FORMAT_MONO16P10, (UINT32)-1},	               // 76
};
