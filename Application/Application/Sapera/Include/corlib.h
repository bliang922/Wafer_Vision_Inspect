...
#pragma warning( pop)
	  ...
	  #undef CorStrcat_s
	  #define CorStrcat_s( strDestination, numberOfElements, strSource ) strcat( strDestination, strSource ) // Closest function in linux (numberOfElements = Size of the destination string buffer.)
