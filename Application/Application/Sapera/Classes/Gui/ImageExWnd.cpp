...
void CImageExWnd::EnableCrosshair(bool enable)
{
   m_viewportWnd.EnableCrosshair(enable);
}

bool CImageExWnd::IsCrosshairEnabled() const
{
   return m_viewportWnd.IsCrosshairEnabled();
}
